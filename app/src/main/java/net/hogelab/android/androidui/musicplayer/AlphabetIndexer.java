...
public class AlphabetIndexer extends DataSetObserver implements SectionIndexer {
     ...
     */
    public AlphabetIndexer(Cursor cursor, int sortedColumnIndex, CharSequence alphabet, boolean ignoreCase) {
        mDataCursor = cursor;
    ...
    protected int compare(String word, String letter) {
        ...
        int result;
        if (mIgnoreCase) {
            result = firstLetter.compareToIgnoreCase(letter);
        } else {
            result = firstLetter.compareTo(letter);
        }
